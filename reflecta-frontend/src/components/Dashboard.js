        ...
        steps={[
          {
            ...
            description: "• Your personal growth command center\n• All reflections, goals & progress unite here\n• See AI-powered insights & patterns\n• Discover what makes each goal unique",
            selector: null,
          },
          {
            icon: "📊",
            title: "Stats Overview",
            description: "• Primary goals & sub-goals count\n• Total journal entries tracked\n• This week's new entries\n• Story of your commitment to growth",
            selector: ".stats-overview",
          },
          {
            icon: "🎯",
            title: "Your Goals Overview",
            description: "• Mandalart goals as clickable cards\n• Each card = one sub-goal\n• Click to see AI summaries & entries\n• Goal-specific insights & timeline",
            selector: ".goals-grid",
          },
          {
            icon: "💡",
            title: "Goal Detail Modal Opens",
            description: "• Watch first sub-goal modal open\n• Shows AI progress analysis\n• Distinctive word clouds (unique words)\n• All related journal entries listed",
            selector: null,
          ...
          },
          {
            ...
            description: "• AI-generated progress summaries\n• Word clouds with distinctive vocabulary\n• Timeline of related journal entries\n• Each goal gets unique analysis",
          ...
          },
          {
            ...
            description: "• AI insights on overall progress\n• Analyzes all journal entries\n• Shows patterns & achievements\n• Summaries cached 7 days (cost saving)",
            selector: ".ai-summary-container",
          },
          {
            icon: "💭",
            title: "Emotional Journey",
            description: "• Chart visualizes mood patterns over time\n• See emotional state fluctuations\n• Notice correlations with progress\n• Maybe happiest when achieving milestones!",
            selector: "#emotional-journey-section",
          },
          {
            icon: "☁️",
            title: "Words of Your Journey",
            description: "• 'All Time': Words from all entries\n• 'Last 3 Months': Recent themes\n• See how your focus evolves\n• Toggle to compare consistency vs. change",
            selector: "#word-cloud-section",
          },
          {
            icon: "🔍",
            title: "Distinctive Word Clouds",
            description: "• Click sub-goal → see unique words only\n• Common words filtered out\n• Reveals what makes each goal distinct\n• Example: 'network' (Career), 'workout' (Health)",
            selector: null,
          },
          {
            icon: "🔄",
          ...
          },
          {
            icon: "🎉",
            title: "Tour Complete!",
            description: "• You understand Reflecta now!\n• Try exploring on your own\n• Journal, set goals, review insights\n• Your growth journey starts here!",
            selector: null,
          },
        ]}
      />

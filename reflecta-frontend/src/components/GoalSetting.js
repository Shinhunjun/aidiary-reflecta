        ...
        steps={[
          {
            ...
            description: "• Use the Mandalart framework for goal planning\n• 1 main goal → 8 sub-goals → 64 actionable tasks\n• Create your roadmap to success!",
            selector: null,
          },
          {
            icon: "🎯",
            title: "The Mandalart Grid",
            description: "• 3×3 grid = your goal planning canvas\n• Center cell = main goal\n• 8 surrounding cells = sub-goals\n• Each sub-goal expands to show 8 tasks",
            selector: ".mandalart-grid",
          },
          {
            icon: "⭐",
            title: "Set Your Main Goal",
            description: "• Center cell = your ultimate objective\n• Click to enter your main goal\n• Make it meaningful and specific!\n• Demo goal: 'Achieve Holistic Personal Growth'",
            selector: ".mandalart-cell.center",
          },
          {
            icon: "🤖",
            title: "AI Goal Assistant",
            description: "• Stuck on sub-goals? Let AI help!\n• Analyzes your main goal\n• Suggests 8 relevant sub-goals automatically\n• Like having a personal coach",
            selector: ".mandalart-primary-btn",
          },
          {
            icon: "📝",
            title: "Sub-Goal Cells",
            description: "• 8 surrounding cells = sub-goals\n• Major categories supporting main goal\n• Examples: Career, Health, Wellness\n• Each breaks down into 8 action items",
          ...
          },
          {
            ...
            description: "• Watch as we expand the first sub-goal\n• Shows 8 actionable tasks for this goal\n• Define concrete steps here\n• Example: 'Network with leaders', 'Get certified'",
            selector: null,
          ...
          },
          {
            ...
            description: "• Expanded 3×3 grid of action tasks\n• These are specific things you'll do\n• 8 sub-goals × 8 tasks = 64 actionable items\n• Center = sub-goal, surrounding = 8 tasks",
            selector: ".mandalart-overlay-grid",
            waitForElement: true,
          },
          {
            icon: "🔗",
            title: "Link Your Goals",
            description: "• Save goals to enable AI linking\n• AI analyzes journal entries automatically\n• Maps entries to relevant goals & tasks\n• Powers progress tracking & insights",
            selector: ".mandalart-solid-btn",
          },
          {
            icon: "📔",
            title: "Next: Start Journaling!",
            description: "• Goals are set! Time to journal\n• Chat with AI about your experiences\n• Get help reflecting on your progress\n• Convert chats to structured journal entries",
            selector: null,
          },
        ]}
      />
